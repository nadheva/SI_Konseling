...
<div class="container">
    <div class="row">
        <div class="col-sm-10 offset-sm-1">
            <h2 class="text-center pt-4">Edit Konselor</h2>
            @foreach($konselor as $k)
            <form class="form-horizontal" method="post" action="/konselor/update/{$konselor->id}">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_konselor') is-invalid @enderror" id="nama_siswa" placeholder="Masukkan Nama Konselor" name="nama_konselor" value="{{$k->nama_konselor}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Masukkan NIP" name="nip" value="{{$k->nip}}">
                    @error('nip')
                    <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="col-sm-4">
                    <input type="date" class="form-control" id="ttl" placeholder=" " name="ttl" value="{{$k->ttl}}">
                </div>
            </div>
